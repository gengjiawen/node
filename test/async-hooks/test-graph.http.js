...
process.on('exit', function() {
  ...
  verifyGraph(hooks, [
    ...
    { type: 'HTTPPARSER', id: 'httpparser:1', triggerAsyncId: 'tcpserver:1' },
    { type: 'TCPWRAP', id: 'tcp:2', triggerAsyncId: 'tcpserver:1' },
    { type: 'Timeout', id: 'timeout:1', triggerAsyncId: 'tcp:2' },
    { type: 'HTTPPARSER', id: 'httpparser:2', triggerAsyncId: 'tcp:2' },
    { type: 'Timeout', id: 'timeout:2', triggerAsyncId: 'httpparser:2' },
