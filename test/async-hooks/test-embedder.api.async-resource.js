...
common.expectsError(() => new AsyncResource(), {
...
checkInvocations(alcazares, { init: 1, before: 1 }, 'alcazares emitted before');
alcaEvent.emitAfter();
checkInvocations(
  alcazares,
...
function tick1() {
  ...
  pobEvent.emitBefore();
  checkInvocations(poblado, { init: 1, before: 1 }, 'poblado emitted before');
