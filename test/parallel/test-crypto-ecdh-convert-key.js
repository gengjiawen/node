...
common.expectsError(() => ECDH.convertKey(cafebabePubPtComp, 'badcurve'), {
  type: TypeError,
...
if (getCurves().includes('secp256k1')) {
  ...
  // Point formats.
  let uncompressed = ECDH.convertKey(
    cafebabePubPtComp,
    'secp256k1',
    'hex',
    'buffer',
  ...
  let compressed = ECDH.convertKey(
    cafebabePubPtComp,
    'secp256k1',
    'hex',
    'buffer',
