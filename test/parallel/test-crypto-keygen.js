...

{
  ...
  generateKeyPair(
    ...
    common.mustCall((err, publicKey, privateKeyDER) => {
      ...
      const privateKey = convertDERToPEM(
...

{
  ...
  common.expectsError(() => generateKeyPair('rsa', common.mustNotCall()), {
    ...
    code: 'ERR_INVALID_ARG_TYPE',
    message:
      'The "options" argument must be of ' +
  ...
  for (const type of [undefined, null, 0, true, {}]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${type}" is invalid for option ` +
  ...
  for (const format of [undefined, null, 0, false, 'a', {}]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${format}" is invalid for option ` +
  ...
  for (const cipher of [0, true, {}]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${cipher}" is invalid for option ` +
  ...
  for (const passphrase of [undefined, null, 5, false, true]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${passphrase}" is invalid for option ` +
  ...
  for (const modulusLength of [undefined, null, 'a', true, {}, [], 512.1, -1]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${modulusLength}" is invalid for option ` +
          '"modulusLength"'
      }
    );
  }
  ...
  for (const publicExponent of ['a', true, {}, [], 3.5, -1]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${publicExponent}" is invalid for option ` +
          '"publicExponent"'
      }
    );
  }
  ...
  for (const divisorLength of ['a', true, {}, [], 4096.1]) {
    common.expectsError(
        ...
        }),
      {
        ...
        code: 'ERR_INVALID_OPT_VALUE',
        message:
          `The value "${divisorLength}" is invalid for option ` +
          '"divisorLength"'
      }
    );
  }
