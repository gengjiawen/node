...
const failingAgentOptions = [true, 'agent', {}, 1, () => null, Symbol()];

const acceptableAgentOptions = [false, undefined, null, new http.Agent()];
...
server.listen(
  ...
  common.mustCall(function() {
    ...
    failingAgentOptions.forEach((agent) => {
      common.expectsError(() => createRequest(agent), {
