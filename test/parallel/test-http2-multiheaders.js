...
function checkHeaders(headers) {
  assert.deepStrictEqual(headers.accept, 'abc, def, ghijklmnop');
  assert.deepStrictEqual(headers['www-authenticate'], 'foo, bar, baz');
  assert.deepStrictEqual(headers['proxy-authenticate'], 'foo, bar, baz');
