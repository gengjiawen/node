...
const tests = {
  ...
  ucs2: [0x74, 0x00, 0xe9, 0x00, 0x73, 0x00, 0x74, 0x00, 0x20, 0x00, 0xac, 0x20]
};
...

{
  ...
  assert.strictEqual(
    ucs2_to_utf8.toString('utf8'),
    utf8_to_ucs2.toString('ucs2')
  );
}

common.expectsError(() => buffer.transcode(null, 'utf8', 'ascii'), {
  type: TypeError,
  code: 'ERR_INVALID_ARG_TYPE',
  message:
    'The "source" argument must be one of type Buffer ' +
