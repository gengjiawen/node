...
const status101regex = /^HTTP status code 101 \(Switching Protocols\) is forbidden in HTTP\/2$/;
const afterRespondregex = /^Cannot specify additional headers after response initiated$/;
...
function onStream(stream, headers, flags) {
  ...
  common.expectsError(() => stream.additionalHeaders({ ':method': 'POST' }), {
