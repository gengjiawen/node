...
assert.throws(() => crypto.pbkdf2('password', 'salt', 1, 20, null), {
  code: 'ERR_INVALID_CALLBACK',
  name: 'TypeError [ERR_INVALID_CALLBACK]'
});

assert.throws(() => crypto.pbkdf2Sync('password', 'salt', -1, 20, 'sha1'), {
...
assert.throws(
  () => crypto.pbkdf2('password', 'salt', 8, 8, common.mustNotCall()),
  {
    ...
    name: 'TypeError [ERR_INVALID_ARG_TYPE]',
    message:
      'The "digest" argument must be one of type string or null. ' +
