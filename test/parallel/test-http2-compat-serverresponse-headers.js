  ...
  common.mustCall(function() {
    ...
    server.once(
      ...
      common.mustCall(function(request, response) {
        ...
        [':status', ':method', ':path', ':authority', ':scheme'].forEach(
          (header) =>
            common.expectsError(() => response.setHeader(header, 'foobar'), {
        ...
        common.expectsError(() => response.setHeader(''), {
        ...
        response.on(
          ...
          common.mustCall(function() {
            ...
            common.expectsError(() => response.setHeader(real, expectedValue), {
