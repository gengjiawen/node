...
common.expectsError(() => zlib.createGzip({ flush: 10000 }), {
...
common.expectsError(() => zlib.createGzip({ finishFlush: 'foobar' }), {
  code: 'ERR_INVALID_ARG_TYPE',
  type: TypeError,
  message:
...
common.expectsError(() => zlib.createGzip({ finishFlush: 10000 }), {
  code: 'ERR_OUT_OF_RANGE',
  type: RangeError,
  message:
